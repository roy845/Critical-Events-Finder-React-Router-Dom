...
import useItemsPerPageGroupedCriticalEvents from "../hooks/useItemsPerPageGroupedCriticalEvents";

const ItemsPerPageGroupedCriticalEvents = () => {
  const { itemsPerPage, handleItemsPerPageChange } =
    useItemsPerPageGroupedCriticalEvents();
...
export default ItemsPerPageGroupedCriticalEvents;
